          ...
          <div className="flex flex-row justify-evenly w-full flex-wrap">
            ...
            <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
              ...
              <div className="flex">
                ...
                {cartIds.includes(data.id) ? <Link to="/cart" className="flex ml-auto bg-gradient-to-tr from-pink-600 to-fuchsia-500 font-semibold text-white border-0 py-2 px-6 focus:outline-none  rounded">
                  Go TO CART
